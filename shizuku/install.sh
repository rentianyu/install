...
install() {
    # 下载 dex
    curl -s https://cdn.jsdelivr.net/gh/rentianyu/install@main/shizuku/rish_shizuku.dex >$PREFIX/bin/rish_shizuku.dex
    # 下载 rish
    curl -s https://cdn.jsdelivr.net/gh/rentianyu/install@main/shizuku/rish >$PREFIX/bin/rish
    # 修改rish里的包名
